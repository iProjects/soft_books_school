...
{
    public partial class SearchStudentAccountsSimpleForm : Form
    {
        ...
        public SearchStudentAccountsSimpleForm(string Conn)
        {
            InitializeComponent();
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            if (dataGridViewAccounts.SelectedRows.Count != 0)
            {
                ...
                try
                {
                    ...
                    OnStudentAccountsListSelected(this, new StudentAccountsSelectEventArgs(selectedAccount));
        ...
        private void SearchAccountsSimpleForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                txtAccountId_Leave(sender, e);
                txtAccountName_Leave(sender, e);
                txtAccountNo_Leave(sender, e);
