...
namespace WinSBSchool.Forms
{
    public partial class UserControlDoublePost : UserControl
    {
        ...
        public UserControlDoublePost(TransactionType ttype, string _user, string Conn, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
            InitializeComponent();
            ...
            _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("finished UserControlDoublePost initialization", TAG));
        ...
        private void UserControlDoublePost_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("finished UserControlDoublePost load", TAG));
        ...
        private void cboModeofPayment_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (cboModeofPayment.SelectedValue.ToString())
            {
                ...
                case "M":
                    ...
                    tableLayoutPanelDPost.SetRow(groupBoxMpesa, 3);
                    tableLayoutPanelDPost.SetColumn(groupBoxMpesa, 1);
                    groupBoxCheque.Visible = false;
                    groupBoxBankSlip.Visible = false;
                    break;
                case "B":
                    groupBoxBankSlip.Visible = true;
                    tableLayoutPanelDPost.SetRow(groupBoxBankSlip, 3);
                    tableLayoutPanelDPost.SetColumn(groupBoxBankSlip, 1);
                    groupBoxCheque.Visible = false;
                    groupBoxMpesa.Visible = false;
                    break;
                case "C":
