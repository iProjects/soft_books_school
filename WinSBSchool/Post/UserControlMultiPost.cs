...
{
    public partial class UserControlMultiPost : UserControl
    {
        Repository rep;
        ...
        private void UserControlMultiPost_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tableLayoutPanelMPost.RowStyles[10].Height = 0;
                this.tableLayoutPanelMPost.RowStyles[11].Height = 0;
        ...
        private void ConfigureScreen()
        {
            ...
            switch (TType.ScreenViewCreditAccountField)
            {
                ...
                case "X": //Not visible
                    ...
                    this.tableLayoutPanelMPost.RowStyles[7].Height = 0;
                    break;
            }
            switch (TType.ScreenViewCreditNarrativeField)
            {
                ...
                case "X": //Not visible
                    ...
                    this.tableLayoutPanelMPost.RowStyles[6].Height = 0;
                    break;
            }
            switch (TType.ScreenViewDebitAccountField)
            {
                ...
                case "X": //Not visible
                    ...
                    this.tableLayoutPanelMPost.RowStyles[2].Height = 0;
                    break;
            }
            switch (TType.ScreenViewDebitNarrativeField)
            {
                ...
                case "X": //Not visible
                    ...
                    this.tableLayoutPanelMPost.RowStyles[5].Height = 0;
                    break;
            }
            switch (TType.ScreenViewAmountField)
            {
                ...
                case "X": //Not visible
                    ...
                    this.tableLayoutPanelMPost.RowStyles[8].Height = 0;
                    break;
            }
            switch (TType.ScreenViewModeofPaymentField)
            {
                ...
                case "X": //Not visible
                    ...
                    this.tableLayoutPanelMPost.RowStyles[3].Height = 0;
                    break;
            }
            switch (TType.ScreenViewValueDateField)
            {
                ...
                case "X": //Not visible
                    ...
                    this.tableLayoutPanelMPost.RowStyles[9].Height = 0;
                    break;
            }
        ...
        private bool IsTransactionValid()
        {
            ...
            if (string.IsNullOrEmpty(txtDrAccount.Text))
            {
                ...
                errorProvider.SetError(txtDrAccount, "Account ID cannot be null!");
                noerror = false;
            }
            int _draccountid;
            if (!int.TryParse(txtDrAccount.Text, out _draccountid))
            {
                ...
                errorProvider.SetError(txtDrAccount, "Account ID must be integer!");
                noerror = false;
            }
            ...
            {
                errorProvider.SetError(txtDrAccount, "Error retrieving the account!");
                noerror = false;
            }
            ...
            {
                errorProvider.SetError(txtCrAccount, "Account ID cannot be null!");
                noerror = false;
            }
            int _craccountid;
            if (!int.TryParse(txtCrAccount.Text, out _craccountid))
            {
                errorProvider.SetError(txtCrAccount, "Account ID must be integer!");
                noerror = false;
            }
            ...
            if (null == CrAccountBeforePosting)
            {
                ...
                errorProvider.SetError(txtCrAccount, "Error retrieving the account!");
                noerror = false;
            }
            //amount 
    ...
    = (KeyValuePair<string, string>)cboModeofPayment.SelectedItem;
            ...
            try
            {
                if (IsTransactionValid())
                {
                    ...
                    try
                    {
                        ...
                        var transmsg = DebitTransaction.TransRef + " Confirmed. Kshs " + DebitTransaction.Amount + " sent to " + rep.GetAccount(CreditTransaction.AccountId).AccountName + " on " + DebitTransaction.PostDate.ToString("dd-MM-yyyy ") + " at " + DebitTransaction.PostDate.ToString("HH:mm:ss tt") + ". New balance is Kshs " + DebitTransaction.Amount;
                        _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs(transmsg, TAG));

                        MessageBox.Show("Transactions Posted Successfully!", "SB School", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    catch (Exception exc)
                    {
                        _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs(exc.ToString(), TAG));
                        Utils.ShowError(exc);
                        return;
                    }
        ...
        private string get_student_name()
        {
            string student_name = string.Empty;

            return student_name;
        }
        private string get_student_admin_no()
        {
            string student_admin_no = string.Empty;

            return student_admin_no;
        }
        private string get_class_name()
        {
        ...
        private void PrintReciept(string ReceiptLayout, object[] PostObject)
        {
            try
            {
                ...
                //streamToPrint = new StreamReader ("C:\\MyFile.log");
                //try
                //{
        ...
        private void cboModeofPayment_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (cboModeofPayment.SelectedValue.ToString())
            {
                ...
                case "M":
                    ...
                    tableLayoutPanelMPost.SetRow(groupBoxMpesa, 3);
                    tableLayoutPanelMPost.SetColumn(groupBoxMpesa, 1);
                    groupBoxCheque.Visible = false;
                    groupBoxBankSlip.Visible = false;
                    break;
                case "B":
                    groupBoxBankSlip.Visible = true;
                    tableLayoutPanelMPost.SetRow(groupBoxBankSlip, 3);
                    tableLayoutPanelMPost.SetColumn(groupBoxBankSlip, 1);
                    groupBoxCheque.Visible = false;
                    groupBoxMpesa.Visible = false;
                    break;
                case "C":
        ...
        private void btnSelectDrAccount_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SearchAccountsSimpleForm saf = new SearchAccountsSimpleForm(user, connection, _notificationmessageEventname) { Owner = myForm };
