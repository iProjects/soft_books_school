...
{
   public class SecERByEPByCBySByETPDFBuilder
   {
        string sFilePDF;
        SecERByEPByCBySByETViewModel secERByEPByCBySByETViewModel;
        string Message;
        Document document;
        ...
        public SecERByEPByCBySByETPDFBuilder(SecERByEPByCBySByETViewModel _secERByEPByCBySByETViewModel, string FileName)
        {
            secERByEPByCBySByETViewModel = _secERByEPByCBySByETViewModel;
            sFilePDF = FileName;
        }
        ...
        private void AddDocHeader()
        {
            ...
            try
            {
                ...
                Cell RCell = new Cell(new Phrase(secERByEPByCBySByETViewModel.ReportName, new Font(Font.HELVETICA, 15, Font.BOLD, Color.BLUE)));
                ...
                Image img0 = pdfgen.DoGetImageFile(secERByEPByCBySByETViewModel.SchoolLogo);
                ...
                Logcell.Add(new Phrase(secERByEPByCBySByETViewModel.SchoolSlogan, new Font(Font.HELVETICA, 8, Font.ITALIC, Color.BLACK)));
                examResultByExamPeriodByClassTable.AddCell(Logcell);

                Cell reportdateCell = new Cell(new Phrase("Report Date:     " + secERByEPByCBySByETViewModel.ReportDate.ToString("MMMM  dd, yyyy"), hFont));
        ...
        {
            //foreach (var item in secERByEPByCBySByETViewModel.ExamResults)
            //{
            //    AddExamPeriodTableDetails(item);
            //}

        }
        //private void AddExamPeriodTableDetails(SecExamResultsByClassBySubjectByExamTypeDTO ercdto)
        //{
        ...
        //}
        //table headers
        //private void BuildExamResultsTable(List<SecSubjectExamResult> studentexamresult)
        //{
        //    //Create table
