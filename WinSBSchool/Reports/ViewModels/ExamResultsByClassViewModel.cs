...
{
    public class ExamResultsByClassViewModel
    {
        ...
        public string ReportName
        {
            get
            {
                return "Exam Results By Class\n";
            }
        }

        public List<ExamResultsByClassDTO> ExamResults { get; set; }
        public List<int> _Students { get; set; }
        public List<string> _Subjects { get; set; }
        public List<string> _ExamTypes { get; set; }
    }

    public class ExamResultsByClassDTO
    {
        ...
        public List<ClassSubjectsExamTypes> StudentExamResults { get; set; }
        public double TotalMarks
        {
            get
            {
                var res = StudentExamResults.Select(t => t.MeanMarks);
                if (res.Count() > 0)
                {
                    return res.Sum();
                }
