...
{
    public class ExamResultsBySubjectViewModel
    {
        ...
        public string ExamShortcode { get; set; }
        public DateTime? ExamDate { get; set; }
        public string ReportName
        {
            get
            {
                return "Exam Results By Subject\n";
            }
        }
        public List<ExamResultsBySubjectDTO> ExamResults { get; set; }
    ...
    public class ExamResultsBySubjectDTO
    {
