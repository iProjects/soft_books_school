...
{
   public class SchoolPerformanceByTargetViewModelBuilder
    {
        ...
        public SchoolPerformanceByTargetViewModelBuilder(DAL.School _school, string Conn)
        {
        ...
        public SchoolPerformanceByTargetViewModel GetSchoolPerformanceByTargetViewModelBuilder()
        {
            try
            {
                if (!error)
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new SchoolPerformanceByTargetViewModel();
