...
{
   public class FeeStructureByProgrammeViewModelBuilder 
   {
        ...
        public FeeStructureByProgrammeViewModelBuilder(School _school, DAL.Programme _programme, string Conn)
        {
        ...
        public FeeStructureByProgrammeViewModel GetFeeStructureByProgrammeViewModelBuilder()
        {
            try
            {
                if (!error)
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new FeeStructureByProgrammeViewModel();
