...
{
  public  class ClassProgressFormViewModelBuilder
   {
        ...
        public ClassProgressFormViewModelBuilder(School _school, DAL.SchoolClass _schoolClass, string Conn)
        {
        ...
        public ClassProgressFormViewModel GetModelBuilder()
        {
            try
            {
                if (!error)
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ClassProgressFormViewModel();
