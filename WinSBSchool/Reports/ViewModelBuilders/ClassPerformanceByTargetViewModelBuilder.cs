...
{
   public class ClassPerformanceByTargetViewModelBuilder
    {       
        ...
        public ClassPerformanceByTargetViewModelBuilder(School _school, DAL.SchoolClass _schoolClass, string Conn)
        {
        ...
        public ClassPerformanceByTargetViewModel GetModelBuilder()
        {
            try
            {
                if (!error)
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ClassPerformanceByTargetViewModel();
