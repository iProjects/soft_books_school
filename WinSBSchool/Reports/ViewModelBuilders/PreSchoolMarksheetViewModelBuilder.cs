...
{
   public class PreSchoolMarksheetViewModelBuilder
     {
          Repository rep;
        SBSchoolDBEntities db;
        bool error = false;
        PreSchoolMarksheetViewModel _ViewModel;
        ...
        public PreSchoolMarksheetViewModelBuilder(School _school, RegisteredExam registeredExam, ExamPeriod examperiod, SchoolClass cls, string Conn)
        {
        ...
        public PreSchoolMarksheetViewModel GetViewModel()
        {
            try
            {
                if (!error) Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new PreSchoolMarksheetViewModel();
