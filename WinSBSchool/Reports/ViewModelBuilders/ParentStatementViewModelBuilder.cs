...
{
   public class ParentStatementViewModelBuilder
    {
        Repository rep; 
       ...
       public ParentStatementViewModelBuilder(School _school, int accountid, DateTime startdate, DateTime enddate, string Conn)
        {
       ...
       public ParentStatementViewModel GetViewModel()
        {
            try
            {
                if (!error) Build();
        ...
        public void Build()
       {
           try
           {
            _ViewModel = new ParentStatementViewModel();
