...
{
   public class ClassConsolidatedMarksheetViewModelBuilder
   {
        ...
        public ClassConsolidatedMarksheetViewModelBuilder(School _school, DAL.SchoolClass _schoolClass, string Conn)
        {
        ...
        public ClassConsolidatedMarksheetViewModel GetClassConsolidatedMarksheetViewModelBuilder()
        {
            try
            {
                if (!error)
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new ClassConsolidatedMarksheetViewModel();
