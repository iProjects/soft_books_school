...
{
   public class CollegeMarksheetViewModelBuilder
     {
        Repository rep;
        ...
        public CollegeMarksheetViewModelBuilder(School _school, RegisteredExam registeredExam, ExamPeriod examperiod, SchoolClass cls, string Conn)
        {
        ...
        public CollegeMarksheetViewModel GetViewModel()
        {
            try
            {
                if (!error) Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new CollegeMarksheetViewModel();
