...
{
    public class SecondaryMarkSheetViewModelBuilder
    {
        Repository rep;
        SBSchoolDBEntities db; 
        SecondaryMarkSheetViewModel _ViewModel;
        ...
        public SecondaryMarkSheetViewModelBuilder(School _school, RegisteredExam registeredExam, ExamPeriod examperiod, SchoolClass cls, string Conn)
        {
        ...
        public SecondaryMarkSheetViewModel GetViewModel()
        {
            try
            { 
                Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new SecondaryMarkSheetViewModel();
