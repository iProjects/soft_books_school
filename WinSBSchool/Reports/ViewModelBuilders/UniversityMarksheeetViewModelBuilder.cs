...
{
   public class UniversityMarksheeetViewModelBuilder
    {
         Repository rep;
        ...
        public UniversityMarksheeetViewModelBuilder(School _school, RegisteredExam registeredExam, ExamPeriod examperiod, SchoolClass cls, string Conn)
        {
        ...
        public UniversityMarksheeetViewModel GetViewModel()
        {
            try
            {
                if (!error) Build();
        ...
        private void Build()
        {
            try
            {
                _ViewModel = new UniversityMarksheeetViewModel();

                _ViewModel.printedon = DateTime.Today;
                _ViewModel.ReportDate = DateTime.Today;
                _ViewModel.ClassName = _cls.ClassName.Trim(); 
