...
{
    public class PreSchoolMarksheeetPDFBuilder
    {
        string sFilePDF;
        ...
        public PreSchoolMarksheeetPDFBuilder(PreSchoolMarksheetViewModel _PSMarksheetViewModel, List<string> _Subjects, string FileName, string Conn)
        {
            ...
            if (_PSMarksheetViewModel == null)
                throw new ArgumentNullException("PreSchoolMarksheetViewModel is invalid");
            _ViewModel = _PSMarksheetViewModel;
