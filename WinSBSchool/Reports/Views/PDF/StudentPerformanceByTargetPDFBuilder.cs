...
{
    public class StudentPerformanceByTargetPDFBuilder
    {
        ...
        public StudentPerformanceByTargetPDFBuilder(StudentPerformanceByTargetViewModel _studentPerformanceByTargetViewModel, string FileName)
        {
           
            if (_studentPerformanceByTargetViewModel == null)
                throw new ArgumentNullException("StudentPerformanceByTargetViewModel is null");
            _ViewModel = _studentPerformanceByTargetViewModel;
