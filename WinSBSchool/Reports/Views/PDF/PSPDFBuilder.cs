   ...
   public class PSPDFBuilder
    {
        ...
        public PSPDFBuilder(PSViewModel _PSViewModel, string FileName)
        {
            _ViewModel = _PSViewModel;
            if (_PSViewModel == null)
                throw new ArgumentNullException("_PSViewModel is null");
