...
{
    public class StudentExtraCurriculaPDFBuilder
      {
        ...
        public StudentExtraCurriculaPDFBuilder(StudentExtraCurriculaViewModel _studentExtraCurriculaViewModel, string FileName)
        {
           
            if (_studentExtraCurriculaViewModel == null)
                throw new ArgumentNullException("StudentExtraCurriculaViewModel is null");
            _ViewModel = _studentExtraCurriculaViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table extraCurriculuarTable = new Table(5);
                extraCurriculuarTable.WidthPercentage = 100;
                extraCurriculuarTable.Padding = 1;
                extraCurriculuarTable.Spacing = 1;
                extraCurriculuarTable.Border = Table.NO_BORDER;
                ...
                extraCurriculuarTable.AddCell(SchoolNameCell);
                ...
                extraCurriculuarTable.AddCell(SchoolAddressCell);
                ...
                extraCurriculuarTable.AddCell(reportNameCell);
                ...
                extraCurriculuarTable.AddCell(nullCell);
                ...
                extraCurriculuarTable.AddCell(logoCell);
                ...
                extraCurriculuarTable.AddCell(reportdateCell); 

                document.Add(extraCurriculuarTable);
