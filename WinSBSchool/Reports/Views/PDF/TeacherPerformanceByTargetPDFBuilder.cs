...
{
    public class TeacherPerformanceByTargetPDFBuilder
  {
        ...
        public TeacherPerformanceByTargetPDFBuilder(TeacherPerformanceByTargetViewModel _teacherPerformanceByTargetViewModel, string FileName)
        {
           
            if (_teacherPerformanceByTargetViewModel == null)
                throw new ArgumentNullException("TeacherPerformanceByTargetViewModel is null"); 
            _ViewModel = _teacherPerformanceByTargetViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table performanceByTargetTable = new Table(5);
                performanceByTargetTable.WidthPercentage = 100;
                performanceByTargetTable.Padding = 1;
                performanceByTargetTable.Spacing = 1;
                performanceByTargetTable.Border = Table.NO_BORDER;
                ...
                performanceByTargetTable.AddCell(SchoolNameCell);
                ...
                performanceByTargetTable.AddCell(SchoolAddressCell);
                ...
                performanceByTargetTable.AddCell(reportNameCell);
                ...
                performanceByTargetTable.AddCell(nullCell);
                ...
                performanceByTargetTable.AddCell(logoCell);
                ...
                performanceByTargetTable.AddCell(reportdateCell); 

                document.Add(performanceByTargetTable);
