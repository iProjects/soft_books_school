...
{
    public class TertiaryMarksheeetPDFBuilder
    {
        string sFilePDF;
        ...
        public TertiaryMarksheeetPDFBuilder(TertiaryMarksheetViewModel _TerMarksheetViewModel, List<string> _Subjects, string FileName, string Conn)
        {
            ...
            if (_TerMarksheetViewModel == null)
                throw new ArgumentNullException("TertiaryMarksheetViewModel is invalid");
            _ViewModel = _TerMarksheetViewModel;
