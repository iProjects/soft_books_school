...
{
    public class StudentPaymentReceiptsPDFBuilder
      {
        string sFilePDF;
        ...
        public StudentPaymentReceiptsPDFBuilder(PaymentReceiptsViewModel _paymentReceiptsViewModel, string FileName)
        {
           
            if (_paymentReceiptsViewModel == null)
                throw new ArgumentNullException("PaymentReceiptsViewModel is null");
            _ViewModel = _paymentReceiptsViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table paymentReceiptTable = new Table(5);
                paymentReceiptTable.WidthPercentage = 100;
                paymentReceiptTable.Padding = 1;
                paymentReceiptTable.Spacing = 1;
                paymentReceiptTable.Border = Table.NO_BORDER;
                ...
                paymentReceiptTable.AddCell(SchoolNameCell);
                ...
                paymentReceiptTable.AddCell(SchoolAddressCell);
                ...
                paymentReceiptTable.AddCell(reportNameCell);
                ...
                paymentReceiptTable.AddCell(nullCell);
                ...
                paymentReceiptTable.AddCell(logoCell);
                ...
                paymentReceiptTable.AddCell(reportdateCell); 

                document.Add(paymentReceiptTable);
