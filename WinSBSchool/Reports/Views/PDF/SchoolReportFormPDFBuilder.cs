...
{
    public class SchoolReportFormPDFBuilder
      {
        ...
        public SchoolReportFormPDFBuilder(SchoolReportFormViewModel _schoolReportFormViewModel, string FileName)
        {
           
            if (_schoolReportFormViewModel == null)
                throw new ArgumentNullException("SchoolReportFormViewModel is null");
            _ViewModel = _schoolReportFormViewModel;
