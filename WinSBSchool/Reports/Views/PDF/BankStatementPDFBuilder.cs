...
{
    public class BankStatementPDFBuilder
       {
        string sFilePDF;
        ...
        public BankStatementPDFBuilder(BankStatementViewModel _bankstatementviewModel, string FileName)
        {
            if (_bankstatementviewModel == null)
                throw new ArgumentNullException("BankStatementViewModel is null");
            _ViewModel = _bankstatementviewModel;
