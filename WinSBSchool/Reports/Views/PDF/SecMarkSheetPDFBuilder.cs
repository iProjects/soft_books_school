...
{
    public class SecondaryMarkSheetPDFBuilder
    {
        string sFilePDF;
        ...
        public SecondaryMarkSheetPDFBuilder(SecondaryMarkSheetViewModel _MarkSheetViewModel, List<string> _Subjects, string FileName, string Conn)
        {
            ...
            if (_MarkSheetViewModel == null)
                throw new ArgumentNullException("SecondaryMarkSheetViewModel is invalid");
