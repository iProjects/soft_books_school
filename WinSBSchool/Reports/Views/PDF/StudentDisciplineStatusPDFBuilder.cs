...
{
    public class StudentDisciplineStatusPDFBuilder
      {
        ...
        public StudentDisciplineStatusPDFBuilder(StudentDisciplineStatusViewModel _studentDisciplineStatusViewModel, string FileName)
        {
           
            if (_studentDisciplineStatusViewModel == null)
                throw new ArgumentNullException("StudentDisciplineStatusViewModel is null");
            _ViewModel = _studentDisciplineStatusViewModel;
