...
{
    public class ParentStatementPDFBuilder
    {
        string sFilePDF;
        ParentStatementViewModel _ViewModel;
        string Message;
        Document document;
        ...
        public ParentStatementPDFBuilder(ParentStatementViewModel _parentStatementViewModel, string FileName)
        {
            if (_parentStatementViewModel == null)
                throw new ArgumentNullException("ParentStatementViewModel is null");
            _ViewModel = _parentStatementViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            {
                ...
                Image img0 = pdfgen.DoGetImageFile(_ViewModel.Logo.Trim());
                ...
                logoCell.Add(new Phrase(_ViewModel.CompanySlogan.Trim(), new Font(Font.HELVETICA, 8, Font.ITALIC, Color.BLACK)));
                ...
                Cell customerCell = new Cell(new Phrase("CUSTOMER", hFont));
