...
{
    public class CollegeMarksheetPDFBuilder
    {
        string sFilePDF;
        CollegeMarksheetViewModel _ViewModel;
        string Message;
        string connection;
        ...
        public CollegeMarksheetPDFBuilder(CollegeMarksheetViewModel _CollMarksheetViewModel, List<string> _Subjects, string FileName, string Conn)
        {
            ...
            if (_CollMarksheetViewModel == null)
                throw new ArgumentNullException("CollegeMarksheetViewModel is invalid");
            _ViewModel = _CollMarksheetViewModel;
