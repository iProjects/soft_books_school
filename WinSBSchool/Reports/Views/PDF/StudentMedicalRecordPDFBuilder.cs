...
{
    public class StudentMedicalRecordPDFBuilder
      {
        ...
        public StudentMedicalRecordPDFBuilder(StudentMedicalRecordViewModel _studentMedicalRecordViewModel, string FileName)
        {
           
            if (_studentMedicalRecordViewModel == null)
                throw new ArgumentNullException("StudentMedicalRecordViewModel is null");
            _ViewModel = _studentMedicalRecordViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table medicalRecordsTable = new Table(5);
                medicalRecordsTable.WidthPercentage = 100;
                medicalRecordsTable.Padding = 1;
                medicalRecordsTable.Spacing = 1;
                medicalRecordsTable.Border = Table.NO_BORDER;
                ...
                medicalRecordsTable.AddCell(SchoolNameCell);
                ...
                medicalRecordsTable.AddCell(SchoolAddressCell);
                ...
                medicalRecordsTable.AddCell(reportNameCell);
                ...
                medicalRecordsTable.AddCell(nullCell);
                ...
                medicalRecordsTable.AddCell(logoCell);
                ...
                medicalRecordsTable.AddCell(reportdateCell); 
