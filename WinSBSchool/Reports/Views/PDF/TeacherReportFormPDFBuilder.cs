...
{
    public class TeacherReportFormPDFBuilder
     {
        ...
        public TeacherReportFormPDFBuilder(TeacherReportFormViewModel _teacherAcademicReportFormViewModel, string FileName)
        {
           
            if (_teacherAcademicReportFormViewModel == null)
                throw new ArgumentNullException("TeacherReportFormViewModel is null"); 
            _ViewModel = _teacherAcademicReportFormViewModel;
