...
{
    public class UniversityMarksheeetPDFBuilder
    {
        string sFilePDF;
        UniversityMarksheeetViewModel _ViewModel;
        string Message;
        string connection;
        ...
        public UniversityMarksheeetPDFBuilder(UniversityMarksheeetViewModel _UniMarksheeetViewModel, List<string> _Subjects, string FileName, string Conn)
        {
            ...
            if (_UniMarksheeetViewModel == null)
                throw new ArgumentNullException("UniversityMarksheeetViewModel is invalid");
            _ViewModel = _UniMarksheeetViewModel;
