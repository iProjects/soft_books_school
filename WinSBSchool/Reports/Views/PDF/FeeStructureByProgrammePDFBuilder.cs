...
{
    public class FeeStructureByProgrammePDFBuilder
    {
        
        string sFilePDF;
        FeeStructureByProgrammeViewModel _ViewModel;
        string Message;
        Document document;
        ...
        public FeeStructureByProgrammePDFBuilder(FeeStructureByProgrammeViewModel _feeStructureByProgrammeViewModel, string FileName)
        {
           
            if (_feeStructureByProgrammeViewModel == null)
                throw new ArgumentNullException("FeeStructureByProgrammeViewModel is null");
            _ViewModel = _feeStructureByProgrammeViewModel;
