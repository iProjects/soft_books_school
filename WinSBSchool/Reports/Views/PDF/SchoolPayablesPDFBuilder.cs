...
{
    public class SchoolPayablesPDFBuilder
     {
        ...
        public SchoolPayablesPDFBuilder(SchoolPayablesViewModel _schoolPayablesViewModel, string FileName)
        {
           
            if (_schoolPayablesViewModel == null)
                throw new ArgumentNullException("SchoolPayablesViewModel is null");
            _ViewModel = _schoolPayablesViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table schoolpayablesTable = new Table(5);
                schoolpayablesTable.WidthPercentage = 100;
                schoolpayablesTable.Padding = 1;
                schoolpayablesTable.Spacing = 1;
                schoolpayablesTable.Border = Table.NO_BORDER;
                ...
                schoolpayablesTable.AddCell(SchoolNameCell);
                ...
                schoolpayablesTable.AddCell(SchoolAddressCell);
                ...
                schoolpayablesTable.AddCell(reportNameCell);
                ...
                schoolpayablesTable.AddCell(nullCell);
                ...
                schoolpayablesTable.AddCell(logoCell);
                ...
                schoolpayablesTable.AddCell(reportdateCell); 

                document.Add(schoolpayablesTable);
