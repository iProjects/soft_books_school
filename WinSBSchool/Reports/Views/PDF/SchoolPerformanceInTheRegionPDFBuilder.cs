...
{
    public class SchoolPerformanceInTheRegionPDFBuilder
      {
        ...
        public SchoolPerformanceInTheRegionPDFBuilder(SchoolPerformanceInTheRegionViewModel _schoolPerformanceInTheRegionViewModel, string FileName)
        {
          
            if (_schoolPerformanceInTheRegionViewModel == null)
                throw new ArgumentNullException("SchoolPerformanceInTheRegionViewModel is null"); 
            _ViewModel = _schoolPerformanceInTheRegionViewModel;
