...
{
    public class FeeStructureByClassPDFBuilder
    {
        ...
        public FeeStructureByClassPDFBuilder(FeeStructureByClassViewModel _feeStructureByClassViewModel, string FileName)
        {

            if (_feeStructureByClassViewModel == null)
                throw new ArgumentNullException("FeeStructureByClassViewModel is null");
