...
{
    public class TeacherProgressFormPDFBuilder
     {
        
        string sFilePDF;
        TeacherProgressFormViewModel _ViewModel;
        string Message;
        Document document;
        ...
        public TeacherProgressFormPDFBuilder(TeacherProgressFormViewModel _teacherAcademicProgressFormViewModel, string FileName)
        {
           
            if (_teacherAcademicProgressFormViewModel == null)
                throw new ArgumentNullException("TeacherProgressFormViewModel is null");
            _ViewModel = _teacherAcademicProgressFormViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table progressTable = new Table(5);
                progressTable.WidthPercentage = 100;
                progressTable.Padding = 1;
                progressTable.Spacing = 1;
                progressTable.Border = Table.NO_BORDER;
                ...
                progressTable.AddCell(SchoolNameCell);
                ...
                progressTable.AddCell(SchoolAddressCell);
                ...
                progressTable.AddCell(reportNameCell);
                ...
                progressTable.AddCell(nullCell);
                ...
                progressTable.AddCell(logoCell);
                ...
                progressTable.AddCell(reportdateCell); 
