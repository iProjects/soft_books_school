...
{
    public class SchoolPerformanceByTargetPDFBuilder
      {
       
        string sFilePDF;
        SchoolPerformanceByTargetViewModel _ViewModel;
        string Message;
        Document document;
        ...
        public SchoolPerformanceByTargetPDFBuilder(SchoolPerformanceByTargetViewModel _schoolPerformanceByTargetViewModel, string FileName)
        {
           
            if (_schoolPerformanceByTargetViewModel == null)
                throw new ArgumentNullException("SchoolPerformanceByTargetViewModel is null");
            _ViewModel = _schoolPerformanceByTargetViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table schoolPerformanceTable = new Table(5);
                schoolPerformanceTable.WidthPercentage = 100;
                schoolPerformanceTable.Padding = 1;
                schoolPerformanceTable.Spacing = 1;
                schoolPerformanceTable.Border = Table.NO_BORDER;
                ...
                schoolPerformanceTable.AddCell(SchoolNameCell);
                ...
                schoolPerformanceTable.AddCell(SchoolAddressCell);
                ...
                schoolPerformanceTable.AddCell(reportNameCell);
                ...
                schoolPerformanceTable.AddCell(nullCell);
                ...
                schoolPerformanceTable.AddCell(logoCell);
                ...
                schoolPerformanceTable.AddCell(reportdateCell); 

                document.Add(schoolPerformanceTable);
