...
{
    public class ExamResultsByExamTypePDFBuilder
    {
        string sFilePDF;
        ...
        //DEFINED fONTS
        Font hFont = new Font(Font.HELVETICA, 8, Font.NORMAL, Color.DARK_GRAY);//DOCUMENT HEADER 
        Font thFont = new Font(Font.HELVETICA, 8, Font.BOLD, Color.BLUE);//TABLE HEADER
        Font tdFont = new Font(Font.HELVETICA, 7, Font.NORMAL, Color.BLACK);//TABLE BODY
        Font tdFont1 = new Font(Font.HELVETICA, 7, Font.BOLD, Color.BLACK);//TABLE BODY
        Font rms10Normal = new Font(Font.HELVETICA, 6, Font.NORMAL, Color.BLACK);//DOCUMENT FOOTER


        public ExamResultsByExamTypePDFBuilder(ExamResultsByExamTypeViewModel _examResultByExamTypeViewModel, string FileName, string Conn)
        {
            ...
            if (_examResultByExamTypeViewModel == null)
                throw new ArgumentNullException("ExamResultsByExamTypeViewModel is invalid");
            _ViewModel = _examResultByExamTypeViewModel;
        ...
        //table details 
        private void AddTableDetails(Table resultsTable, ExamResultsByExamTypeDTO stRec)
        {
            try
            {
                ...
                if (_ViewModel._Subjects.Count() > 0)
                {
                    ...
                    {
                        var rec = stRec.StudentExamResults.Where(s => s.SubjectCode == sub).SingleOrDefault();
