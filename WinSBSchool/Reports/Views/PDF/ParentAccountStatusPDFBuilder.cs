...
{
    public class ParentAccountStatusPDFBuilder
     {
        ...
        public ParentAccountStatusPDFBuilder(ParentAccountStatusViewModel _ParentAccountStatusViewModel, string FileName)
        {
            
            if (_ParentAccountStatusViewModel == null)
                throw new ArgumentNullException("ParentAccountStatusViewModel is null");
            _ViewModel = _ParentAccountStatusViewModel;
