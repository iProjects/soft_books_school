...
{
   public class ClassConsolidatedMarksheetPDFBuilder
     {
       
        string sFilePDF;
        ClassConsolidatedMarksheetViewModel _ViewModel;
        string Message;
        Document document;
        ...
        public ClassConsolidatedMarksheetPDFBuilder(ClassConsolidatedMarksheetViewModel _classConsolidatedMarksheetViewModel, string FileName)
        {
           
            if (_classConsolidatedMarksheetViewModel == null)
                throw new ArgumentNullException("ClassConsolidatedMarksheetViewModel is null");
            _ViewModel = _classConsolidatedMarksheetViewModel;
        ...
        {  
                Table classConsolidatedMarkSheetTable = new Table(5);
                classConsolidatedMarkSheetTable.WidthPercentage = 100;
                classConsolidatedMarkSheetTable.Padding = 1;
                classConsolidatedMarkSheetTable.Spacing = 1;
                classConsolidatedMarkSheetTable.Border = Table.NO_BORDER;
                ...
                classConsolidatedMarkSheetTable.AddCell(SchoolNameCell);
                ...
                classConsolidatedMarkSheetTable.AddCell(SchoolAddressCell);
                ...
                classConsolidatedMarkSheetTable.AddCell(reportNameCell);
                ...
                classConsolidatedMarkSheetTable.AddCell(nullCell);
                ...
                classConsolidatedMarkSheetTable.AddCell(logoCell);
                ...
                classConsolidatedMarkSheetTable.AddCell(reportdateCell); 

                document.Add(classConsolidatedMarkSheetTable);
        ...
        private void AddDocFooter()
        {
            ...
            Table classConsolidatedMarkSheetTable = new Table(1);
            classConsolidatedMarkSheetTable.WidthPercentage = 100;
            classConsolidatedMarkSheetTable.Border = Table.NO_BORDER;
            ...
            classConsolidatedMarkSheetTable.AddCell(sgCell);
