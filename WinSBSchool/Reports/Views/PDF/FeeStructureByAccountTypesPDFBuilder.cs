...
{
    public class FeeStructureByAccountTypesPDFBuilder
     {
        ...
        public FeeStructureByAccountTypesPDFBuilder(FeeStructureByAccountTypesViewModel _feeStructureByAccountTypesViewModel, string FileName)
        {
            _ViewModel = _feeStructureByAccountTypesViewModel;
            if (_feeStructureByAccountTypesViewModel == null)
                throw new ArgumentNullException("FeeStructureByAccountTypesViewModel is null");
