...
{
    public class SchoolProgressFormPDFBuilder
      {
        ...
        public SchoolProgressFormPDFBuilder(SchoolProgressFormViewModel _schoolProgressFormViewModel, string FileName)
        {
            
            if (_schoolProgressFormViewModel == null)
                throw new ArgumentNullException("SchoolProgressFormViewModel is null");
            _ViewModel = _schoolProgressFormViewModel;
