...
{
    public class StudentAttendanceRecordPDFBuilder
      {
        ...
        public StudentAttendanceRecordPDFBuilder(StudentAttendanceRecordViewModel _studentAttendanceRecordViewModel, string FileName)
        {
          
            if (_studentAttendanceRecordViewModel == null)
                throw new ArgumentNullException("StudentAttendanceRecordViewModel is null"); 
            _ViewModel = _studentAttendanceRecordViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table studentAttendanceTable = new Table(5);
                studentAttendanceTable.WidthPercentage = 100;
                studentAttendanceTable.Padding = 1;
                studentAttendanceTable.Spacing = 1;
                studentAttendanceTable.Border = Table.NO_BORDER;
                ...
                studentAttendanceTable.AddCell(SchoolNameCell);
                ...
                studentAttendanceTable.AddCell(SchoolAddressCell);
                ...
                studentAttendanceTable.AddCell(reportNameCell);
                ...
                studentAttendanceTable.AddCell(nullCell);
                ...
                studentAttendanceTable.AddCell(logoCell);
                ...
                studentAttendanceTable.AddCell(reportdateCell); 

                document.Add(studentAttendanceTable);
