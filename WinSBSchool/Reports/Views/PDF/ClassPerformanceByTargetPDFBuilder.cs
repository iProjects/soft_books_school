...
{
    public class ClassPerformanceByTargetPDFBuilder
     {

        string sFilePDF;
        ClassPerformanceByTargetViewModel _ViewModel;
        string Message;
        Document document;
        ...
        public ClassPerformanceByTargetPDFBuilder(ClassPerformanceByTargetViewModel _feeStructureByClassViewModel, string FileName)
        {
          
            if (_feeStructureByClassViewModel == null)
                throw new ArgumentNullException("ClassPerformanceByTargetViewModel is null");
            _ViewModel = _feeStructureByClassViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table performanceTable = new Table(5);
                performanceTable.WidthPercentage = 100;
                performanceTable.Padding = 1;
                performanceTable.Spacing = 1;
                performanceTable.Border = Table.NO_BORDER;
                ...
                performanceTable.AddCell(SchoolNameCell);
                ...
                performanceTable.AddCell(SchoolAddressCell);
                ...
                performanceTable.AddCell(reportNameCell);
                ...
                performanceTable.AddCell(nullCell);
                ...
                performanceTable.AddCell(logoCell);
                ...
                performanceTable.AddCell(reportdateCell); 
        ...
        private void AddDocFooter()
        {
            ...
            Table performanceTable = new Table(1);
            performanceTable.WidthPercentage = 100;
            performanceTable.Border = Table.NO_BORDER;
            ...
            performanceTable.AddCell(sgCell);
