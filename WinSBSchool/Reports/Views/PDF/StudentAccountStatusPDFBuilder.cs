...
{
    public class StudentAccountStatusPDFBuilder
      {
        ...
        public StudentAccountStatusPDFBuilder(StudentAccountStatusViewModel _studentAccountStatusViewModel, string FileName)
        {
            
            if (_studentAccountStatusViewModel == null)
                throw new ArgumentNullException("StudentAccountStatusViewModel is null");
            _ViewModel = _studentAccountStatusViewModel;
        ...
        private void AddDocHeader()
        {
            ...
            try
            { 
                Table accountStatusTable = new Table(5);
                accountStatusTable.WidthPercentage = 100;
                accountStatusTable.Padding = 1;
                accountStatusTable.Spacing = 1;
                accountStatusTable.Border = Table.NO_BORDER;
                ...
                accountStatusTable.AddCell(SchoolNameCell);
                ...
                accountStatusTable.AddCell(SchoolAddressCell);
                ...
                accountStatusTable.AddCell(reportNameCell);
                ...
                accountStatusTable.AddCell(nullCell);
                ...
                accountStatusTable.AddCell(logoCell);
                ...
                accountStatusTable.AddCell(reportdateCell); 

                document.Add(accountStatusTable);
